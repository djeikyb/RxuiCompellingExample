...
namespace RxuiCompellingExample
{
    ...
    public partial class NugetDetailsView : ReactiveWindow<NugetDetailsViewModel>
    {
        public NugetDetailsView()
        {
            ...
            this.WhenActivated(disposableRegistration =>
            {
                ...
                this.OneWayBind<NugetDetailsViewModel, NugetDetailsView, Uri, IImage>(ViewModel,
